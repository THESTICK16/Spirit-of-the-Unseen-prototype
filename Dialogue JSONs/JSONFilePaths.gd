...
#Actually, this might be fixed by loading from res:// instead
...
const ITEM_ACQUISITION_TEXT_JSON_FILEPATH = "res://Dialogue JSONs/Item Acquisition JSON Sheet.json"
...
const MISCELLANEOUS_MESSAGES_JSON_FILEPATH = "res://Dialogue JSONs/MiscellaneousMessages.json"
