...
#	Calculations.make_vector_directional(Vector2(0, 0))
#	Calculations.make_vector_directional(Vector2(2, 2))
#	Calculations.make_vector_directional(Vector2(-3, 2))
#	Calculations.make_vector_directional(Vector2(3, 2))
#	Calculations.make_vector_directional(Vector2(3, 1))
#	Calculations.make_vector_directional(Vector2(-3, -1))
#	Calculations.make_vector_directional(Vector2(-3, -17))
#	Calculations.make_vector_directional(Vector2(3, 31))
#	Calculations.make_vector_directional(Vector2(-30, 100))
#	Calculations.make_vector_directional(Vector2(30, -100))
#	print("//")
#	Calculations.make_vector_directional(Vector2(1, 1))
#	Calculations.make_vector_directional(Vector2(-1, -1))
